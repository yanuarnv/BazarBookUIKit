...
extension NovelsList: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return isLoading ? skeletonCellCount : viewModel.novelsList.count
    }
...
extension NovelsList: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
